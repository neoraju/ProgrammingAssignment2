...
## Second function cacheSolve checks if the inverse of matrix already calculated by looking in the first function and if not, calculates, stores in the first function and displays the result.
